...
Item {
    ...
    Loader{
        id:track;
        anchors.right: orientation == Qt.Vertical ?
                           parent.right : parent.right;
        anchors.bottom: orientation == Qt.Vertical ?
                            parent.bottom : null;
    ...
    Loader{
        id:thumb
        anchors.horizontalCenter: orientation == Qt.Vertical ?
                                      track.horizontalCenter : null;
//        anchors.verticalCenter: orientation == Qt.Vertical ?
//                                      track.verticalCenter : null;
